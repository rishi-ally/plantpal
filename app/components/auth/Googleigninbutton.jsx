...
import { auth, db, messaging } from '@/app/lib/firestore'
...
const Googleigninbutton = () => {
  const {setcurrentdisplay}=useContext(Mycontext)
  ...
  return (
    <>
     ...
     onClick={handlegooglesignin}
          className="flex items-center cursor-pointer justify-center gap-3 w-full py-3 rounded-lg border-2 border-green-500 bg-green-50 text-green-900 font-semibold text-lg hover:bg-green-100 hover:shadow-lg transition duration-300 select-none"
          aria-label="Sign in with Google"
        >
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="60" viewBox="0 0 100 100">
...
export default Googleigninbutton